(function() {
    ...
    if (window.pdfjsLib && window.cpvSettings) {
        pdfjsLib.GlobalWorkerOptions.workerSrc = cpvSettings.workerUrl;
    }
        ...
        roots.forEach(function(root) {
            ...
            function renderDocument() {
                ...
                for (var i = 1; i <= S.pdf.numPages; i++) {
                    ...
                    pageCanvas.className = 'pv-cont-page';
                        ...
                        S.scrollObserver = new IntersectionObserver(function(entries) {
                            entries.forEach(function(entry) {
                                if (entry.isIntersecting) {
                                    ...
                                    if (thumbsCont) {
                                        thumbsCont.querySelectorAll('.pv-thumb-item').forEach(function(el, idx) {
            ...
            async function activateViewer() {
                ...
                if (S.page > 1) {
                    setTimeout(function() {
                        var startCanvas = canvasWrap.querySelectorAll('.pv-cont-page')[S.page - 1];
